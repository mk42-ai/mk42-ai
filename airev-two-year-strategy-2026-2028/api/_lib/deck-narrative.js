...
VALUATION ARC (label 12 / #16) — exactly three steps: $200M (Series A2 pre-money, closing January 2027) → $500M round (≈ April 2027, with modular DC #1 live with Tenstorrent) → $1B round (≈ July 2027, the UAE's first AI unicorn). Quote only these three steps — never a band between the second and third step or any intermediate valuation figure; the older wording was removed. Multiples: $200M = 6.31× FY2029 contracted exit ARR ($31.7M); $500M ≈ 17× FY2027E revenue ($29.0M) or ≈ 8× FY2028E revenue ($62.6M); $1B ≈ 16× FY2028E revenue. Public figures (Gulf News, 13 Aug 2026, AIREV × Qualcomm Dragonwing): 4M+ users, 300+ agents in 50+ languages, 6.8 trillion tokens in Q2 2026 (≈6× YoY) — distinct from the ~97K verified users on card 02. UAE non-oil trade 2025: AED 3.8T ≈ $1.03T (+27% vs 2024, +44.3% vs 2023); non-oil exports AED 813.8B (+45.5% YoY, +85% vs 2023, 21.6% of non-oil trade). VentureWave Capital (Ireland) invested in the Series A (announced 2025); Core42 (G42) is the seed investor; AIREV was founded in 2023 by Muhammed Khalid, Dr Youssef Youssef and Kayaan Unwalla; OnDemand launched July 2024. The $500M and $1B round SIZES are not contracted or documented: the deck models a PROJECTION of USD 25M at USD 500M pre and USD 50M at USD 1B pre (5% of pre-money) and labels them "projection ○".

ROUTES TO MARKET — fifteen routes, each tagged with its instrument: signed agreements (Qualcomm TLA + SOW, Tenstorrent CCA, World Wide Technology reseller, Redington MoA, Core42 and ADQ MSAs), signed MoUs (Intel, WISER), a Supermicro certification, channel/integrator partnerships (Cisco, NetApp, IBM · Dell, Moro Hub, UXE, e& SOW) and the VVIP Sovereign JV whose MoU is a gate for 8–10 October — never describe all fifteen as "signed" (Qualcomm, Intel, Tenstorrent, World Wide Technology, Redington, WISER, Core42 · ADQ, Supermicro, Cisco, NetApp, Moro Hub, UXE, e&, IBM · Dell, VVIP Sovereign JV). The UAE white-label reseller that appeared in older builds is NOT a route in the deck (removed 8 Sep 2026) — do not present any partner outside this list as a route, reseller or signed instrument. Card 10 "Partner scale & reach" shows six routes by latest fiscal-year revenue: Cisco $63.3B, Qualcomm $44.3B, WWT ~$20B, e& $19.9B, Redington $13.5B, NetApp $6.92B. Reach copy: Redington = 30+ markets · South Asia · MEA · Turkey · Africa · 39,500+ channel partners; Qualcomm = 5 silicon families · factory pre-load · 111K → 562.5K devices 2026 → 2028E.
