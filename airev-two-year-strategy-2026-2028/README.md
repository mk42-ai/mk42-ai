...
Interactive, spatial strategy deck (37 cards on a six-lane map, story flow Mandate → Proof → Partners → Capital → Scale) prepared for the Chairman and Board — Private & Confidential, 5 September 2026.
...
- `index.html` — the 37 cards (32 + the coded “Silk Road for AI” map card + the four investor-economics cards 14–17 in the Capital lane, 8 Sep 2026: “Round-by-round: dollars raised and dilution” (#18 — per-round table + stacked ownership by holder group), “Money in: % bought and what it is worth” (#19 — per-investor value at $215M / $200M / $500M / $1B), “Who came in at what — and what they have made” (#20 — entry, cash in, stake, unrealised multiple, preference amount) and “Control: where founder consent stops” (#21 — founders’ FD and voting lines against the 50% Cl. 1.1 test, consent gates, what to negotiate)) (hero numbers, icon rows, progressive-disclosure reveals, source tags)
- `content.js` — eight-quarter roadmap, fifteen signed routes to market, JV scenario toggle, modular-DC cost-share toggle, valuation slider, charts, and the `CAPITAL` model (Cap table 26 Jul 2026 — “Final Cap table post Series-A1”, table dated 11/6/2025 — joined to A&R SHA Schedule 2 prices, the Series A2 at $200M pre per the Terra draft with the Itqan V6 $137.85M alternative, and the $500M / $1B rounds) that renders the dilution lines on card 13 and cards 14–17 at run time — `CAPITAL.assumedRaise` (USD 25M at $500M pre, USD 50M at $1B pre; 5% of pre-money) is the one labelled assumption, `CAPITAL.stressRaise` the 10% sensitivity; `window.capitalModel` exposes the computed ladder for QA
...
- `assets/` — hero art, press photos, charts, partner logos (all fifteen routes plus ADEX/ADFD, Masdar, Space42, Kairoswealth, B Capital — served same-origin, never hot-linked; the anonymised VVIP Sovereign JV carries a coded emblem) and OnDemand brand glyphs
