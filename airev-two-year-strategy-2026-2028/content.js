...
(function(){
  ...
  /* ---------------- Routes to market — fifteen routes, each tagged with its instrument (agreement / MoU / LOI / certification / MoU to sign) ---------------- */
  const P=[{"n": "Qualcomm", "cat": "silicon", "logo": "assets/logos/qualcomm.png", "role": "Technology licence agreement: $100 per activated unit, perpetual, across five silicon families.", "detail": "Snapdragon X AI PCs, Cloud AI 100/Ultra, Dragonwing IQ-X, XR2/AR1 glasses and AI200/AI250 racks carry OnDemand; installed base 111,000 (2026) to 562,500 (2028).", "reach": "5 silicon families · 562.5K devices 2028E", "dark": false, "inst": "● Agreement · TLA + SOW", "instCls": "signed"}, {"n": "Intel", "cat": "silicon", "logo": "assets/logos/intel.png", "role": "AI PC MOU: offline OnDemand for Windows on Panther Lake, delivered February 2026.", "detail": "Puts a fully offline sovereign assistant on Intel AI PCs through 2027–2028, widening the OEM installed base beyond Qualcomm silicon and feeding the licensing revenue line.", "reach": "Panther Lake AI PC platform", "dark": false, "inst": "● MoU signed", "instCls": "signed"}, {"n": "Tenstorrent", "cat": "silicon", "logo": "assets/logos/tenstorrent.svg", "role": "Commercial Collaboration Agreement (1 Sep 2025) plus LOI cost-sharing the first modular sovereign DC.", "detail": "Tenstorrent cost-shares ~50% of the UAE's first modular sovereign data centre: 23 Galaxy units, 736 Blackhole chips, $2.9–4.4M fleet all-in, live with the $500M round around April 2027.", "reach": "23 Galaxy units · 736 Blackhole chips", "dark": false, "inst": "● Agreement (CCA) · cost-share LOI ◐", "instCls": "signed"}, {"n": "World Wide Technology", "cat": "channel", "logo": "assets/logos/wwt.png", "role": "Reseller agreement carrying US federal and state contract flow-downs.", "detail": "Opens US public-sector procurement for the sovereign appliance and OnDemand licences, a key contributor to the ≥40% (Sep 2027) and ≥60% (Sep 2028) export-booking targets.", "reach": "US federal & state flow-downs", "dark": false, "inst": "● Agreement · reseller", "instCls": "signed"}, {"n": "Redington", "cat": "channel", "logo": "assets/logos/redington.png", "role": "Distribution across 8 MENA markets and all of Africa on a fixed price card.", "detail": "Price card $110K/$200K/$360K; Redington SISA sits beside the new Bangalore hub, giving the Africa and South Asia export push a fulfilment backbone.", "reach": "8 MENA markets · all of Africa", "dark": false, "inst": "● Agreement · MoA", "instCls": "signed"}, {"n": "WISER Technology", "cat": "channel", "logo": "assets/logos/wiser.png", "role": "European channel partnership anchored on a 2027 lighthouse deployment.", "detail": "The 2027 European lighthouse becomes the reference site for EU sovereign buyers and a core plank of the ≥40% / ≥60% export-share targets.", "reach": "European lighthouse 2027", "dark": false, "inst": "● MoU signed", "instCls": "signed"}, {"n": "Core42 · ADQ", "cat": "sovereign", "logo": "assets/logos/core42.png", "role": "Master services agreements with Core42 (G42) and ADQ.", "detail": "Anchors OnDemand inside the UAE's sovereign cloud and state-holding ecosystem; MSAs give the JV, GCC government deployments and owned-compute plans a contracted enterprise frame.", "reach": "UAE sovereign cloud & state holding", "dark": false, "inst": "● Agreements · MSAs", "instCls": "signed"}, {"n": "Supermicro", "cat": "silicon", "logo": "assets/logos/supermicro.png", "role": "Certified sovereign appliance platform: Supermicro AS-2115HV-TNRT.", "detail": "The certified AS-2115HV-TNRT is the reference on-prem appliance for channel deployments via Redington and WWT, deployable inside Moro Hub or customer sites.", "reach": "AS-2115HV-TNRT certified", "dark": true, "inst": "● Certification", "instCls": "signed"}, {"n": "Cisco", "cat": "silicon", "logo": "assets/logos/cisco.png", "role": "Networking partner and government channel for sovereign deployments.", "detail": "Cisco networking underpins the sovereign stack while its government channel carries OnDemand into public-sector accounts in the GCC, US and Europe alongside WWT and WISER.", "reach": "Networking + government channel", "dark": false, "inst": "◐ Channel via WWT rack", "instCls": "model"}, {"n": "NetApp", "cat": "silicon", "logo": "assets/logos/netapp.png", "role": "AI data layer for the sovereign OnDemand stack.", "detail": "NetApp provides the governed data layer beneath OnDemand agents in sovereign deployments — the JV, GCC government estates and the modular data centre — keeping data resident in-country.", "reach": "Sovereign AI data layer", "dark": false, "inst": "◐ Channel via WWT rack", "instCls": "model"}, {"n": "Moro Hub (Digital DEWA)", "cat": "sovereign", "logo": "assets/logos/moro-hub.svg", "role": "Hosting in Moro Hub's 100 MW solar-powered Tier III green data centre.", "detail": "Gives OnDemand a DEWA-backed, renewable-powered home for sovereign workloads and JV seats, complementing the Tenstorrent modular data centre as owned compute comes online.", "reach": "100 MW solar · Tier III", "dark": false, "inst": "◐ Hosting partnership", "instCls": "model"}, {"n": "UXE Security Solutions", "cat": "sovereign", "logo": "assets/logos/uxe.png", "role": "Dubai government security and smart-city integrator deploying OnDemand.", "detail": "Brings OnDemand agents into Dubai government security and smart-city programmes, a sovereign showcase feeding the GCC government deployments planned from Q2 2027.", "reach": "Dubai government security & smart city", "dark": false, "inst": "◐ Integrator partnership", "instCls": "model"}, {"n": "e&", "cat": "channel", "logo": "assets/logos/eand.svg", "role": "Enterprise and government distribution; first blended 25,000-device programme with Qualcomm.", "detail": "Programme one blends ~10K AR glasses, ~11K AI PCs and ~4K appliances across e&'s enterprise and government base; activation waves run Q3–Q4 2026, GCC government deployment Q2 2027.", "reach": "244.7M subscribers", "dark": false, "inst": "◐ SOW · 25K-device programme", "instCls": "model"}, {"n": "IBM · Dell", "cat": "channel", "logo": "assets/logos/ibm.png", "role": "Models, channel and certified systems for the OnDemand sovereign stack.", "detail": "IBM and Dell extend OnDemand's model catalogue, enterprise channel and certified server options, giving buyers a second hardware track beside Supermicro across 2027–2028.", "reach": "Models · channel · certified systems", "dark": false, "logo2": "assets/logos/dell.png", "inst": "◐ Channel partnership", "instCls": "model"}, {"n": "VVIP Sovereign JV", "cat": "sovereign", "logo": "assets/logos/vvip-sovereign-jv.svg", "role": "50/50 joint venture with a UAE sovereign counterparty, six-gate plan G1–G6.", "detail": "AED 20.4M committed capital (10.2M per partner); 100 seats Dec 2026, five anchors Jan 2027, billing Feb 2027; revenue AED 15.8M Year 1 to AED 56.9M Year 5.", "reach": "AED 95.0M Year 5 with international expansion", "dark": false, "inst": "○ MoU to sign 8–10 Oct", "instCls": "target"}];
  const pg=$('#pgrid');
  if(pg){
    P.forEach(p=>{ const d=document.createElement('div'); d.className='pcard signed'; d.dataset.c=p.cat; d.dataset.name=p.n;
      ...
      d.innerHTML=`<div class="nm">${logo}<span class="tag ${p.instCls} big">${esc(p.inst)}</span></div><div class="nm" style="font-size:16px">${esc(p.n)}</div><div class="role">${esc(p.role)}</div>${p.reach?`<div class="reach">${esc(p.reach)}</div>`:''}<div class="more">${esc(p.detail)}</div>`;
  ...
  function renderStages(){
    ...
    S.forEach((s,i)=>{
      ...
      const mark=s.projection?'projection ○':'draft term sheets ◐ · closing date is a target ○';
      ...
      /* stage header */
      g+=`<text class="stage-h" x="${cx}" y="${m.t-50}" text-anchor="middle" font-size="12" letter-spacing="2.2" font-weight="600" fill="${s.projection?C.faint:C.money}">${fM(s.preM).toUpperCase()} PRE-MONEY · ${esc(s.when.toUpperCase())}${s.projection?'':' ○'}</text>`;
    ...
    const caps=$('#stage-caps'); if(caps) caps.innerHTML=S.map(s=>`<div class="stage-cap${s.projection?' proj':''}"><b>${s.key==='a2'?'Series A2':(s.key==='r500'?'$500M round':'$1B round')}</b> · ${fM(s.raiseM)} ${s.projection?'projection ○':'per the draft term sheets ◐'} at ${fM(s.preM)} pre → ${fM(+(s.postMoney/1e6).toFixed(s.postMoney>=1e9?2:0))} post · sells ${fP(s.dilution)} · a pre-A2 stake keeps ${fP(s.cumKeep,1)}</div>`).join('');
    /* hover / focus tooltip */
